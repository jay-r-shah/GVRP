...
"""
Cluster .dat files from CVRPlib using k-means clustering.
Creates a new .dat file compatible with GVRP code in the same folder.

createData(filename,nClusters)

Example: createData('P-n76-k5.dat',38)
"""
