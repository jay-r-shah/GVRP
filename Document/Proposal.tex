...
&y_{rp} \ge q_r w_{rp} \label{flow2} r \ne p, r, p \in K\\
...
\multirow{2}{*}{GVRP}          & \multirow{2}{*}{527.813}     & flow                 & 512.75                        & 2.85                  \\
                               &                              & node                 & 464.701                       & 11.96                 \\ \midrule
\multirow{2}{*}{GVRP2}         & \multirow{2}{*}{557.564}     & flow                 & 557.542                       & 0.00                  \\
                               &                              & node                 & 557.564                       & 0.00                  \\ \midrule
\multirow{2}{*}{P-n50-k10-c30} & \multirow{2}{*}{417.742}     & flow                 & 396.038                       & 5.20                  \\
                               &                              & node                 & 343.825                       & 17.69                 \\ \midrule
\multirow{2}{*}{A-n69-k9-c31}  & \multirow{2}{*}{756.131}     & flow                 & 717.343                       & 5.13                  \\
                               &                              & node                 & 566.751                       & 25.05                 \\ \midrule
\multirow{2}{*}{P-n76-k5-c38}  & \multirow{2}{*}{507.991}     & flow                 & 450.746                       & 11.27                 \\
                               &                              & node                 & 399.48                        & 21.36                 \\ \bottomrule
\end{tabular}
\end{table}
...
\label{fig:plot_11}}
\quad
\subfloat[Best known solution (objective = 557.564)]{%
...
\label{fig:plot_11}}
\quad
\subfloat[Best known solution (objective = 756.131)]{%
\includegraphics[width=0.45\textwidth]{A-n69-k9-c31_flow_n69_k32_m6_Q150_TL60_map.png}
\label{fig:plots_12}}
...
\label{fig:plot_11}}
\quad
\subfloat[Best known solution (objective = 417.742)]{%
\includegraphics[width=0.45\textwidth]{P-n50-k10-c30_flow_n50_k31_m5_Q200_optimum.png}
\label{fig:plots_12}}
